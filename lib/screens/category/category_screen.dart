...
class _CategoryScreenState extends State<CategoryScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((Duration timeStamp) {
      categoryController.onboardingKey.currentState!.show();
    });
  }
  ...
  Widget build(BuildContext context) {
    return Onboarding(
      steps: categoryController.steps,
      key: categoryController.onboardingKey,
      child: Scaffold(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    Focus(
                      focusNode: categoryController.overlayKeys[0],
